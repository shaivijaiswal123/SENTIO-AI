...
📌 *SENTIO-AI is a low-cost, intelligent IoT system that detects human emotions in real time using deep learning and dynamically adapts lighting and sound ambience to regulate mood.*
